...
public class PmsOssController {
    ...
    String accessId = "LTAI4FyPnxk3aLD7UGPfv5BK"; // 请填写您的AccessKeyId。
    String accessKey = "xBhdJlknS5LQzWqSbg69Dr8qqm8QWW"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "jmall-1"; // 请填写您的 bucketname 。
